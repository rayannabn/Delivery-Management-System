...
orders = list(db.orders.find({'warehouse_id': ObjectId(warehouse_id), 'status': 'pending'}).limit(10))

if not orders:
    print("No pending orders found for this warehouse!")
    sys.exit(1)
